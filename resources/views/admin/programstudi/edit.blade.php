...
<form action="{{ route('programstudi.update',$programstudi->id) }}" method="POST">
    ...
    <div class="space-y-12">
        <h2 class="text-[28px] font-semibold text-gray-900 mb-4">Edit Program Studi</h2>
        <div class="border-b border-gray-900/10 pb-12 p-6 bg-white border border-gray-200 rounded-lg">
            <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <input id="nama" name="nama" type="text" value="{{ $programstudi->nama }}"
            ...
            <div class="mt-6 flex items-center justify-start gap-x-6">
                <button type="button"
                    class="text-sm/6 font-semibold text-gray-900 hover:text-gray-900 hover:border border-gray-900 rounded-md px-3 py-2" onclick="location.href='{{ route('programstudi.index') }}'">Batal</button>
                <button type="submit"
