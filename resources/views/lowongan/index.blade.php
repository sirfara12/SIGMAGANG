        ...
        <form class="flex w-full max-w-lg" method="GET" action="{{ route('lowongan.index') }}">
            <div class="flex w-full relative">
                ...
                <div class="relative w-full">
                    ...
                    <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm h-full text-white bg-blue-700 rounded-e-lg border border-blue-700 hover:bg-blue-800">🔍</button>
                </div>
            </div>
        </form>
